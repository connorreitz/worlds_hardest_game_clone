...
OFILES = gba.o font.o game.o images/garbage.o images/title_screen.o images/stage1.o setup.o player.o enemy.o images/win_screen.o images/lose_screen.o images/difficulty_meter.o
